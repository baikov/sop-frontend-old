        ...
        <div class="flex-1 md:w-5/8 flex flex-col z-10">
          <h1 class="text-center md:text-left mt-32">
            <span
              ...
              class="animated-text-bg drop-shadow-sm text-2xl xl:text-5xl 2xl:text-7xl block font-black uppercase"
            >
